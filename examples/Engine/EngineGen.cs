...
public class EngineGen
{
  ...
  //for spacewarping
  private double ewgfb1 = 0;
  private double ewgfb2 = 0;
  ...
  public double perform() {
    ...
    double output = hip.perform(fse * getMixCylinders());
    return (spw + output) * .5;
  }
  ...
  */
  ...
  double b, double d, double c) 
  {
    ...
    output = spwHip2.perform(ewgfb1 + ewgfb2 + e2a + e2b);
    return spwHip3.perform(output);
  }
